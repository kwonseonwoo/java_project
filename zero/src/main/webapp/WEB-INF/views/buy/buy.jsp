                    ...
                    <div class="buy-menu">
                        ...
                        <script>
                            $(document).ready(function (){
                            	...
                            	var jsonList = ${list}
                            	console.log("컨트롤러 제이슨 데이터: ", jsonList);
                                ...
                                var buyView = jsonList.forEach((a,i)=>{
                                    var buyTemplate = `
                                    <div class="buy-menu-content">
                                        <div class="bmc-img">
                                            <img src="/img/\${a.product_img1}" style="width: 100%;">
                                        </div>
                                        <div class="bmc-name fw-200">\${a.product_name}</div>
                                        <div class="bmc-quan fw-200">\${a.product_quantity}</div>
                                        <div class="bmc-price fw-200">\${a.product_price}</div>
                                        <div class="bmc-delDate fw-200">\${del_date}</div>
                                    </div>
                                    `;

                                    $('.buy-menu-list').append(buyTemplate);
                                    product_quan_price = product_quan_price + (a.product_quantity * a.product_price);
                                });
		...
		$(document).ready(function(){
			...
			$(".buy-button").on("click", function(e){
				...
				for(var i=0; i<liste.length; i++) {
					product_no[i] = liste[i].product_no;
					product_quantity[i] = liste[i].product_quantity;
					member_no[i] = "<c:out value='${principal.member.member_no}'/>";
					list[i] = {member_no: member_no[i], product_no: product_no[i], product_quantity: product_quantity[i],
							   cart_no: liste[i].cart_no};
				}
